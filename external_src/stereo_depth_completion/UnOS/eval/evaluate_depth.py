"""Depth evaluation metrics -- PyTorch reimplementation (numpy-based)."""
...
def eval_depth(gt_depths, pred_depths, gt_disparities,
               pred_disparities_resized, min_depth=1e-3, max_depth=80):
    ...
    return (abs_rel.mean(), sq_rel.mean(), rms.mean(), log_rms.mean(),
            a1.mean(), a2.mean(), a3.mean(), d1_all.mean())
