"""
KITTI odometry pose evaluation.
Adopted from https://github.com/tinghuiz/SfMLearner and
...
class kittiEvalOdom():
    ...
    def plotPath(self, seq, poses_gt, poses_result):
        ...
        plt.savefig(self.plot_path_dir + "/" + png_title + ".pdf",
    ...
    def eval(self, result_dir):
        ...
        os.makedirs(plot_error_dir, exist_ok=True)
