    ...
    def __getitem__(self, index):
        ...
        if self.training:
            ...
            if random.uniform(0, 1) > 0.5:
                left_image_1 = left_image_1.transpose(Image.Transpose.FLIP_LEFT_RIGHT)
                right_image_1 = right_image_1.transpose(Image.Transpose.FLIP_LEFT_RIGHT)
                left_image_2 = left_image_2.transpose(Image.Transpose.FLIP_LEFT_RIGHT)
                right_image_2 = right_image_2.transpose(Image.Transpose.FLIP_LEFT_RIGHT)
