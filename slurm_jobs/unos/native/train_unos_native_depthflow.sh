#!/bin/bash
#SBATCH --job-name=train_unos_nat_df
...
CHECKPOINT_DIR="$SENIOR_THESIS/augundo-ext/checkpoints/unos_native_depthflow"
...
# Train UnOS depthflow mode from the native stereo checkpoint.
# Follows the UnOS paper two-stage pipeline: stereo -> depthflow.
