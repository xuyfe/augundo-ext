#!/bin/bash
#SBATCH --job-name=eval_bdf_orig_flow
...
CHECKPOINT_FILE="/home/ox4/augundo-ext/checkpoints/bdf_monodepth/model_epoch14"
RESULTS_DIR="$SENIOR_THESIS/augundo-ext/results/bdf_original_flow"
mkdir -p "$RESULTS_DIR"
