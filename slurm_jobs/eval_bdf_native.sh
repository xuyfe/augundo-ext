#!/bin/bash
#SBATCH --job-name=eval_bdf_native
...
CHECKPOINT_DIR="$SENIOR_THESIS/augundo-ext/checkpoints/bdf_unos_augs"
RESULTS_DIR="$SENIOR_THESIS/augundo-ext/results/bdf_native"
mkdir -p "$RESULTS_DIR"
