...
--restore_paths \
    pretrained_models_augundo/depth_completion/voiced/void/voiced-void1500.pth \
...
--output_path \
    pretrained_models_augundo/depth_completion/voiced/void/evaluation_results/nyu_v2 \
--device gpu
