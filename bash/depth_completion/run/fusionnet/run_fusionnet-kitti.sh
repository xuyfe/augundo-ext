...
--restore_paths \
    pretrained_models/depth_completion/fusionnet/kitti/fusionnet-kitti.pth \
--model_name fusionnet_kitti \
--network_modules depth spatial_pyramid_pool \
--min_predict_depth 1.5 \
--max_predict_depth 100.0 \
--min_evaluate_depth 1e-3 \
--max_evaluate_depth 100.0 \
--output_path \
    pretrained_models/depth_completion/fusionnet/kitti/evaluation_results/kitti-val \
--device gpu
